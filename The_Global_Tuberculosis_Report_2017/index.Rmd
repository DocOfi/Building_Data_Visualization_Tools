...
In 2016, about `r round(stat_2016$deaths,0)` people died from TB each day and approximatley `r round(stat_2016$incidence, 0)` new cases of TB were recorded daily worldwide. 
...
Of the `r length(unique(TB.burden$country))` countries in the WHO list of countries, `r length(below$country)` had an increase in estimated incidence of TB cases between the period 2010 to 2016. Among these, `r sum(below$country %in% top30_copy$country)` were from the High Burden countries. These were: `r below$country[below$country %in% top30$country]`
